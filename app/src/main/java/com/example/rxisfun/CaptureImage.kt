...
val TAG = CaptureImage::class.simpleName
...
class CaptureImage : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cameraImg = findViewById(R.id.baal)
    ...
    val onImageAvailableListener = object : ImageReader.OnImageAvailableListener {
        override fun onImageAvailable(reader: ImageReader) {
            Toast.makeText(this@CaptureImage, "Photo Taken!", Toast.LENGTH_SHORT).show()
            val image: Image = reader.acquireLatestImage()
//            val yuvToRgbConverter= YuvToRgbConverter(this@CaptureImage)
...
//            yuvToRgbConverter.yuvToRgb(image, bmp)
            ...
            runOnUiThread {
                ...
                cameraImg.setImageBitmap(bitmapImage)
            }

            //startActivity(Intent(this@CaptureImage,MainActivity::class.java).putExtra("bitmap",bitmapImage))
        }
    }
